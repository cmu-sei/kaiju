...
class GhidraHtmlPlugin implements Plugin<Project> {
    
    void apply(Project project) {
        project.tasks.register('markdownToGhidraHtml', MarkdownToGhidraHtmlTask,
            new Action<MarkdownToGhidraHtmlTask>() {
                @Override
                void execute(MarkdownToGhidraHtmlTask t) {
                    t.group = 'Documentation'
                    t.description = 'Converts Markdown sources into Ghidra Help HTML'
                }
            })
    }
}
