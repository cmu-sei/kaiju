...
public class KaijuExportXrefsToCSVHeadless extends GhidraScript {
    public File csvFile;
    ...
    protected void run() throws Exception {
        ...
        // note: this will automatically overwrite the filename given!
        HeadlessXrefsToCSV.writeCSV(csvFile, currentProgram);
    }
