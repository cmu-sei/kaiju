...
/**
 * An abstract interface to be used for categorizing assembly instructions
 * based on the architecture. Each architecture gets its own implementation.
 * Makes use of the "Strategy" design pattern:
 * https://howtodoinjava.com/design-patterns/behavioral/strategy-design-pattern/
 */
public interface InsnCategorizer {

    // returns array of categories in use by this architecture
    public String[] getValidCategories();

    // returns the string representing the category of the given instruction.
    // the string must match one of the array values from getValidCategories().
