...
/**
 * Interface for CFG nodes/elements to assist in implementing a Visitor pattern.
 * Described well in Wikipedia: https://en.wikipedia.org/wiki/Visitor_pattern.
 */
public interface InsnControlFlowGraphElement {

    void accept(InsnControlFlowGraphElementVisitor visitor);
