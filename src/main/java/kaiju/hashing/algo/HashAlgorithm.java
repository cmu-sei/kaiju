...
/**
 * An abstract interface to be used for representing a hashing algorithm.
 * Each algorithm gets its own implementation.
 * Makes use of the "Strategy" design pattern:
 * https://howtodoinjava.com/design-patterns/behavioral/strategy-design-pattern/
 */
public interface HashAlgorithm {

    // Returns a byte array representing the hash of a Function
    // as computed by the chosen algorithm.
    // The array may vary in size depending on the algorithm used.
