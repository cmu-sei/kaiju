 ...
 * DM21-0792
 */
package kaiju.hashing.algo.impl;

import ghidra.program.model.listing.Function;

import kaiju.hashing.algo.HashAlgorithm;

/**
 * Implementation of HashAlgorithm, specialized for the CERT
 * Position-Independent Code (PIC) Hash using MD5.
 * Makes use of the "Strategy" design pattern:
 * https://howtodoinjava.com/design-patterns/behavioral/strategy-design-pattern/
 */
public class PosIndCodeMd5Algorithm implements HashAlgorithm {
