 ...
 * DM21-0087
 */
package kaiju.plugins.fnhashviewer;
...
/**
 * Tests if a string value contains only HEX (0-9,A-F,a-f) characters.
 */
public class IsHexHashConstraint extends StringDataInstanceColumnConstraint {

	@Override
	public boolean accepts(StringDataInstance value, TableFilterContext context) {
		String s = value.getStringValue();
		return (s != null) && s.chars().allMatch(codePoint -> (48 <= codePoint && codePoint <= 57) || (65 <= codePoint && codePoint <= 70));
	}
