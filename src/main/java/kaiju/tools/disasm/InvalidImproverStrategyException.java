...
/**
 * A custom exception indicating a failure to load a disassembly improvements
 * architecture-based strategy. Could be for a few reasons: the given architecture
 * doesn't exist (a typo?), or is not yet implemented.
 */
public class InvalidImproverStrategyException extends Exception {

    public InvalidImproverStrategyException() {
        super();
    }
}
