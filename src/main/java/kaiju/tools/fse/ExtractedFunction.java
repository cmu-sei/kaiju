...
/**
 * Represents a Function's data needed for the FSE.
 * TODO: How is this related to the FnHashSaveable class?
 */
public class ExtractedFunction {
    ...
    // constructors
    public ExtractedFunction(String pic_hash, Integer num_instructions, Integer num_bytes) {
