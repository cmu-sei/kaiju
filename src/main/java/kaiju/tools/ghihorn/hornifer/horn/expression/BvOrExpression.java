...
public class BvOrExpression implements HornExpression {
     ...
     * @param rhs
     */
    public BvOrExpression(HornExpression lhs, HornExpression rhs) {
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof BvOrExpression))
            return false;
        BvOrExpression other = (BvOrExpression) obj;
        if (lhs == null) {
            if (other.lhs != null)
                return false;
