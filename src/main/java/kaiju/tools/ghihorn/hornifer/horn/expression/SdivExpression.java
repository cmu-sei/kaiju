...
public class SdivExpression implements HornExpression {
    ...
    public BitVecExpr instantiate(GhiHornContext ctx) throws Z3Exception {
        ...
        return ctx.mkBVSDiv(lhsExpr, rhsExpr);
    }
     ...
     * @param rhs
     */
    public SdivExpression(HornExpression lhs, HornExpression rhs) {
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof SdivExpression))
            return false;
        SdivExpression other = (SdivExpression) obj;
        if (lhs == null) {
            if (other.lhs != null)
                return false;
